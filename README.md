...
Эта инструкция предназначена для уверенного пользователя, знакомого с WSL2, Debian и Docker. Здесь приведены минимальные шаги для быстрого и базового развёртывания qBittorrent с VPN в Docker на Debian внутри WSL2.
...
> Подробные и расширенные инструкции, а также решения возможных проблем доступны на [Wiki проекта](https://github.com/danishru/qbt-vpn-wsl2/wiki).

---

Этот быстрый старт поможет вам развернуть qBittorrent с VPN в Docker на Debian внутри WSL2 минимальными усилиями. Более тонкая настройка и дополнительные функции описаны в расширенной документации проекта.
